...
module.exports = class pipoca extends Command {
    ...
    async run(message, args) {
        ...
        var falas = [`<:ShibaNom:655149530408550410> ${message.author.username} **comprou pipoca para observar o acontecido !**`, `<:franpopcorn:655149530437648424> ${message.author.username} **foi ao cinema assistir um filme e comprou pipoca**`];
