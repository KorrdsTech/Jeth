...
module.exports = class Embed extends Command {
  ...
  async run(message, args) {
    const ajuda = new EmbedBuilder()
      ...
      .addFields(`Embed Visualizer`, `Que tal testar sua embed antes de colocar na Jeth? Assim você saberá se há erros ou não. Acesse ao site do [Embed Visualizer](https://leovoel.github.io/embed-visualizer/) e teste.`)
