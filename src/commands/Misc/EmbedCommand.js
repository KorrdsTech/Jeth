...
module.exports = class Embed extends Command {
  ...
  async run(message, args) {
    const ajuda = new EmbedBuilder()
      ...
      .addFields(`Placeholder's`, `**{guild-name}** - Para dar o nome do servidor.\n**{user-icon}** - Para dar o avatar do autor.\n**{guild-icon}** - Para dar o avatar do servidor.\n**{user}** - Para dar o nickname do autor.\n**{mention}** - Para te mencionar.`, false)
      .addFields(`Embed Visualizer`, `Que tal testar sua embed antes de colocar na Moderadora? Assim você saberá se há erros ou não. Acesse ao site do [Embed Visualizer](https://leovoel.github.io/embed-visualizer/) e teste.`)
