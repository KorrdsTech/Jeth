...
module.exports = class Ajuda extends Command {
  ...
  async run(message) {
    ...
    message.reply(`${('Counter')} (${this.getCommmandSize('Counter')})`, this.getCategory('Counter', prefix))
    message.reply(`${('Fun')} (${this.getCommmandSize('Fun')})`, this.getCategory('Fun', prefix))
    message.reply(`${('Misc')} (${this.getCommmandSize('Misc')})`, this.getCategory('Misc', prefix))
    message.reply(`${('Mod')} (${this.getCommmandSize('Mod')})`, this.getCategory('Mod', prefix))
    message.reply(`${('Magic')} (${this.getCommmandSize('Magic')})`, this.getCategory('Magic', prefix))
    message.reply(`${('Social')} (${this.getCommmandSize('Social')})`, this.getCategory('Social', prefix))
    message.reply(`${('VIP')} (${this.getCommmandSize('VIP')})`, this.getCategory('VIP', prefix))
