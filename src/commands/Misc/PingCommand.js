...
module.exports = class Ping extends Command {
  ...
  async run(message, args) {
    ...
    const embed = new EmbedBuilder() // Aqui vai ser a primeira embed que o bot irá mostrar
      ...
      .addFields(`<:9605discordslashcommand:832746852667490334> ⇝ Ajuda`, `Use \`${prefix}ajuda\` para saber mais comandos!`)
    ...
    const embed_ping = new EmbedBuilder() // Aqui vai ser a terceira embed que o bot irá mostrar
      ...
      .setColor(colors['default'])
      .setThumbnail(message.author.displayAvatarURL({ dynamic: true, size: 1024 }))
      .addFields(`<:a_blurplesettings:856174395801075773> ⇝ Ping`, `\`${parseInt(this.client.ws.ping)}\` ms\n`)
      .addFields(`<:9605discordslashcommand:832746852667490334> ⇝ Ajuda`, `Use \`${prefix}ajuda\` para saber mais comandos!`)
