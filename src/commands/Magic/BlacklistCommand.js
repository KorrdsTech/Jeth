  ...
  async run(message, args) {
    ...
    if (guildDocument.blacklist) {
      ...
      guildDocument.save().then(async () => {
        this.client.guilds.cache.fetch(gd => gd.members.unban(usuario))
      ...
      guildDocument.save().then(async () => {
        this.client.guilds.cache.fetch(gd => gd.members.ban(usuario, { reason: `Blacklisted: Quebra dos termos de serviço do discord` }))
