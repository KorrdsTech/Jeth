...
module.exports = class createInvite extends Command {
  ...
  async run(message, args) {
    ...
    if (!guilds.member(this.client.user).permissions.cache.has('CREATE_INSTANT_INVITE')) return message.reply(`<:JethVerificado:666762183249494027> **|** ${message.author} Eu não tenho permissão para criar convites nesse servidor.`)
