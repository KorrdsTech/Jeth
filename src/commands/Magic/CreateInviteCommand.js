...
module.exports = class createInvite extends Command {
  ...
  async run(message, args) {
    ...
    if (!guilds.member(this.client.user).permissions.has('CREATE_INSTANT_INVITE')) return message.channel.send(`<:JethVerificado:666762183249494027> **|** ${message.author} Eu não tenho permissão para criar convites nesse servidor.`)
