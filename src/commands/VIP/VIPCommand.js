...
module.exports = class VipCommand extends Command {
  ...
  async run(message, args) {
    ...
    if (documentVip == null) {
      return message.reply(`<:dot:1040807881248882688> » Você não possui vip no servidor.`)
    }
    ...
    if (!documentVip.vip) {
      ...
      return message.reply(`<:dot:1040807881248882688> » Você não está setado como vip para usufruir das opções.`)
    ...
    const dashboard = new MessageEmbed()
      ...
      .setDescription(`<:dot:1040807881248882688> » Configure seu vip no servidor.`)
      .addFields([
        ...
        switch (x.values[0]) {
          case '1': {
            if (documentVip.roleID) {
              ...
              message.reply(`<:dot:1040807881248882688> » Indique o nome do seu cargo vip.`).then(() => {
                message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 60000, errors: ['time'], max: 1 }).on('collect', async message => {
                  ...
                  if (newnamerole.length > 100) return message.reply(`<:dot:1040807881248882688> » Número máximo (100) de caracteres atingido.`)
                  ...
                  roleedit.edit({
                    ...
                    const msg = await message.reply(`<:dot:1040807881248882688> » Estou editando seu cargo vip no banco de dados.`)
                    setTimeout(() => {
                      msg.edit({ content: `<:dot:1040807881248882688> » Seu cargo vip foi editado no servidor com sucesso.` })
                    }, 5000)
                  })
              ...
              message.reply(`<:dot:1040807881248882688> » Indique o nome do seu cargo vip.`).then(() => {
                message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 60000, errors: ['time'], max: 1 }).on('collect', async message => {
                  ...
                  if (namerole.length > 100) return message.reply(`<:dot:1040807881248882688> » Número máximo (100) de caracteres atingido.`)
                  ...
                  message.guild.roles.create({
                    ...
                    documentVip.save().then(async () => {
                      const msg = await message.reply(`<:dot:1040807881248882688> » Estou salvando seu cargo vip no banco de dados.`)
                      setTimeout(() => {
                        msg.edit({ content: `<:dot:1040807881248882688> » Seu cargo vip no servidor foi salvo com sucesso.` })
                      }, 5000)
                    })
          ...
          case '2': {
            if (documentVip.callID) {
              ...
              message.reply(`<:dot:1040807881248882688> » Indique o novo nome da sua call vip.`).then(() => {
                message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 160000, errors: ['time'], max: 1 }).on('collect', async message => {
                  ...
                  if (newnamecall.length > 50) return message.reply(`<:dot:1040807881248882688> » Número máximo (50) de caracteres atingido.`)
                  ...
                  calledit.edit({
                    ...
                    const msg = await message.reply(`<:dot:1040807881248882688> » Estou editando sua call vip no banco de dados.`)
                    setTimeout(() => {
                      msg.edit({ content: `<:dot:1040807881248882688> » Sua call vip foi editada no servidor com sucesso.` })
                    }, 5000)
                  })
                })
              })
              ...
              if (documentVip.roleID) {
                ...
                message.reply(`<:dot:1040807881248882688> » Indique o nome da sua call vip.`).then(() => {
                  message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 160000, errors: ['time'], max: 1 }).on('collect', async message => {

                    const namecall = message.content
                    if (namecall.length > 50) return message.reply(`<:dot:1040807881248882688> » Número máximo (50) de caracteres atingido.`)
                    ...
                    message.guild.channels.create(namecall, {
                      ...
                      documentVip.save().then(async () => {
                        const msg = await message.reply(`<:dot:1040807881248882688> » Estou salvando sua call vip no banco de dados.`)
                        setTimeout(() => {
                          msg.edit({ content: `<:dot:1040807881248882688> » Sua call vip foi salva no servidor com sucesso.` })
                        }, 5000)
                      })
                ...
                message.reply(`<:dot:1040807881248882688> » Você precisa criar seu cargo vip para conseguir criar a call.`)
          ...
          case '3': {
            ...
            if (documentVip.roleID) {
              ...
              message.reply(`<:dot:1040807881248882688> » Indique a cor do seu cargo vip.`).then(() => {
                message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 60000, errors: ['time'], max: 1 }).on('collect', async message => {
                  ...
                  if (!newcolor.includes('#')) {
                    message.reply(`<:dot:1040807881248882688> » Tipo de cor inválida! Lembre-se que só aceitamos cores Hexadecimal.`)
                    return
                  }

                  if (newcolor.length > 7) return message.reply(`<:dot:1040807881248882688> » Número máximo (7) de caracteres atingido.`)

                  roleedit.edit({
                    color: `${newcolor}`,
                  }).then(async () => {
                    const msg = await message.reply(`<:dot:1040807881248882688> » Estou editando a cor do seu cargo vip no banco de dados.`)
                    setTimeout(() => {
                      msg.edit({ content: `<:dot:1040807881248882688> » A cor do seu cargo vip foi editada no servidor com sucesso.` }) // NIKII... THIS IS FAKE.
                    }, 5000)
                  })
              ...
              message.reply(`<:dot:1040807881248882688> » Você precisa criar seu cargo vip para conseguir editar a cor.`)
            }
          }
            break;
          case '4': {
            ...
            if (documentVip.roleID) {
              ...
              message.reply(`<:dot:1040807881248882688> » Mencione o usuário que você deseja dar o cargo vip.`).then(() => {
                message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 60000, errors: ['time'], max: 1 }).on('collect', async message => {
                  ...
                  if (usuario.id === this.client.user.id) {
                    return message.reply(`<:dot:1040807881248882688> » Eu não posso me setar com o seu cargo vip.`)
                  }
                  if (usuario.roles.cache.has(documentVip.roleID)) return message.reply(`<:dot:1040807881248882688> » Esse usuário já possui seu cargo vip neste servidor.`)

                  usuario.roles.add(documentVip.roleID)

                  const msg = await message.reply(`<:dot:1040807881248882688> » Estou setando o usuário com seu cargo vip no banco de dados.`)
                  setTimeout(() => {
                    msg.edit({ content: `<:dot:1040807881248882688> » O usuário foi setado com seu cargo vip no servidor com sucesso.` }) // NIKII... THIS IS FAKE.
                  }, 5000)
                })
              })
              ...
              message.reply(`<:dot:1040807881248882688> » Você precisa criar seu cargo vip para conseguir adiconar alguém.`)
            }
          ...
          case '5': {
            ...
            if (documentVip.roleID) {
              ...
              message.reply(`<:dot:1040807881248882688> » Mencione o usuário que você deseja tirar o cargo vip.`).then(() => {
                message.channel.createMessageCollector({ filter: m => m.author.id === message.author.id, time: 60000, errors: ['time'], max: 1 }).on('collect', async message => {
                  ...
                  if (usuario.id === this.client.user.id) {
                    return message.reply(`<:dot:1040807881248882688> » Eu não posso me remover com o seu cargo vip.`)
                  }

                  usuario.roles.remove(documentVip.roleID)

                  const msg = await message.reply(`<:dot:1040807881248882688> » Estou tirando o usuário do seu cargo vip no banco de dados.`)
                  setTimeout(() => {
                    msg.edit({ content: `<:dot:1040807881248882688> » O usuário teve o seu cargo vip removido no servidor com sucesso.` }) // NIKII... THIS IS FAKE.
                  }, 5000)
                })
              })
              ...
              message.reply(`<:dot:1040807881248882688> » Você precisa criar seu cargo vip para conseguir remover alguém.`)
            }
          }
        }
      }) // End
