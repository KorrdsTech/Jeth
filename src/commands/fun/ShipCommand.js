...
module.exports = class ShipCommand extends Command {
  ...
  async run(message, args) {
    ...
    embed.addField(`💗 **${person.displayName}** ama **${message.member.displayName}** este tanto:`, `💟 ${Math.floor(love)}%\n\n${loveLevel}`)
    embed.setImage(imagens_ships[Math.floor(Math.random() * imagens_ships.length)])
