...
module.exports = class battle extends Command {
  ...
  async run(message, args) {
    ...
    if (message.author.id == user.id) return message.reply('`Você não pode batalhar contra si mesmo!`').catch(console.error);
