...
const userMutados = new mongoose.Schema({
  _id: String,
  server: String,
  time: Number,
  channel: String
...
exports.Users = Users
const Cargos = mongoose.model('Cargo', Cargo)
exports.Cargo = Cargos
const Canals = mongoose.model('Canal', Canal)
exports.Canal = Canals
const Mutados = mongoose.model('Mutados', userMutados)
